...
- Distinguish NEC/code-driven results from estimating assumptions.
- Treat any user-facing claim of code compliance, pricing, conductor/breaker selection, panel/load impact, persistence, active totals, archive repricing, or live Catalog linkage as requiring evidence.
- Check phone/tablet/desktop and PWA/offline/cache regressions where the changed code can affect them.
...
- P1: material correctness/compliance/workflow defect requiring rework before acceptance.
...
A requires no P0/P1 blockers.
B may contain only P2/minor fixes.
C is required for any P0/P1 blocker.
