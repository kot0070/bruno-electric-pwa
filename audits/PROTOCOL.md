...
3. Run/review deterministic tests and verify CI belongs to the exact audited candidate HEAD.
...
6. Check phone/tablet/desktop and PWA/offline/cache/update implications.
