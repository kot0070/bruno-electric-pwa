...
- Treat any user-facing claim of code compliance, pricing, conductor/breaker selection, panel/load impact, persistence, or active totals as requiring evidence.
