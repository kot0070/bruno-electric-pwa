...
function loadAppBackupDispatch(){var d=window&&window.document,loc=window&&window.location;if(!d||!loc||/electrical-tools\.html$/i.test(loc.pathname||'')||window.BrunoAppBackupDispatch||d.querySelector('script[data-be-app-backup-dispatch]'))return;var s=d.createElement('script');s.src='./electric-app-backup-dispatch.js';s.defer=true;s.setAttribute('data-be-app-backup-dispatch','1');d.head.appendChild(s)}
