...
(function(root){
'use strict';
var JOB_KEY='bruno-electric-v1',VERSION='electrical-tasks-shell-v8',FIELD='electricalTasks',ACTIVE='electricalTaskActiveId';
...
function supportedInputs(type,seed){if(type==='FEEDER_PANEL_RUN'||type==='BRANCH_CIRCUIT_RUN'||type==='EVSE_CIRCUIT'||type==='HVAC_CIRCUIT'||type==='MOTOR_CIRCUIT'||type==='TRANSFORMER_FEED')return circuitInputs(seed);return{}}
