...
(function(root){
'use strict';
var JOB_KEY='bruno-electric-v1',VERSION='electrical-tasks-shell-v4',FIELD='electricalTasks',ACTIVE='electricalTaskActiveId';
...
function supportedInputs(type,seed){if(type==='FEEDER_PANEL_RUN'||type==='BRANCH_CIRCUIT_RUN')return circuitInputs(seed);return{}}
