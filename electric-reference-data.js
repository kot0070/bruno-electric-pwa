...
(function (root) {
  ...
  // NEC Chapter 9 Table 5 — THHN/THWN-2 approximate occupied areas in in².
  ...
  // NEC Chapter 9 Table 4 — total internal cross-sectional area in in².
  const RACEWAY_AREA = Object.freeze({
    ...
    PVC40: {
      ...
      '2-1/2':4.695,'3':7.268,'3-1/2':9.737,'4':12.554,'5':19.761,'6':28.567
    },
    PVC80: {
      '1/2':0.217,'3/4':0.409,'1':0.688,'1-1/4':1.237,'1-1/2':1.647,'2':2.874,
      '2-1/2':4.119,'3':6.442,'3-1/2':8.688,'4':11.258,'5':17.855,'6':25.598
    }
  });
