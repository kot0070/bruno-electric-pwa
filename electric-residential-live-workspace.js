...
window.addEventListener('storage',function(e){if(!e||e.key===JOB_KEY)render()});window.addEventListener('focus',render);window.BrunoResidentialLiveWorkspace={render:render};
})();
