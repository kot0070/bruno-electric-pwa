...
function patch(){ensureSettingsAuthority();patchLegacyEditor();patchMetrics();patchCallCards();patchMiniInvoices();patchPreview();syncPreviewHistory();document.documentElement.setAttribute('data-be-runtime-authority','v1.12')}
...
window.BrunoRuntimeAuthorityV1={version:'1.12.0',schedule:schedule,customerTaxPct:customerTaxPct,customerTotal:customerTotal,reservePct:reservePct,salesPct:salesPct,syncCallTaxSnapshots:syncCallTaxSnapshots};
