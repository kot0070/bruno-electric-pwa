...
function data(){var d=read(DATA_KEY,{calls:[]});d.calls=Array.isArray(d.calls)?d.calls:[];return d}
...
function patch(){ensureSettingsAuthority();patchLegacyEditor();patchMetrics();patchCallCards();patchMiniInvoices();patchPreview();syncPreviewHistory();document.documentElement.setAttribute('data-be-runtime-authority','v1.24')}
...
window.BrunoRuntimeAuthorityV1={version:'1.24.0',schedule:schedule,customerTaxPct:customerTaxPct,customerTotal:customerTotal,reservePct:reservePct,salesPct:salesPct,syncCallTaxSnapshots:syncCallTaxSnapshots};
