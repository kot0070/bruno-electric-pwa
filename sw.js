/* Bruno Electric Estimating — app shell offline cache. Previous cache: bruno-electric-v38 */
const CACHE = 'bruno-electric-v39';
...
const CORE_SHELL = [
  ...
  './electric-dispatch-journal-v2.js','./electric-project-mode.js',
  ...
  './electrical-phase3-ui.js','./electrical-tools-shell.js'
];
