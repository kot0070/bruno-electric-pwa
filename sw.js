/* Bruno Electric Estimating — app shell offline cache. Previous cache: bruno-electric-v49; accepted baseline cache: bruno-electric-v45; earlier audited cache: bruno-electric-v40. */
const CACHE = 'bruno-electric-v50';
...
const CORE_SHELL = [
  ...
  './electric-dispatch-journal-v2.js','./electric-catalog-cost-semantics.js','./electric-pricing-margins-semantics.js','./electric-job-material-cost-semantics.js','./electric-job-summary-semantics.js','./electric-quote-lifecycle.js','./electric-catalog-job-ux-semantics.js','./electric-custom-materials.js',
  ...
  './electric-residential-live.js','./electric-residential-live-levels.js','./electric-residential-live-history.js','./electric-residential-live-workspace.js','./electric-residential-wire-takeoff.js','./electric-residential-apply-job.js','./electric-residential-save-archive-ux.js',
