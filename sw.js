/* Bruno Electric Estimating — app shell offline cache. Previous cache: bruno-electric-v52; current: bruno-electric-v53. Historical audited baseline: bruno-electric-v45. */
const CACHE = 'bruno-electric-v53';
...
const CORE_SHELL = [
  ...
  './electric-reference-data.js','./electric-calculators.js','./electric-catalog-v1.js','./electric-bom.js','./electric-electrical-tasks.js','./electrical-tasks-ui.js',
