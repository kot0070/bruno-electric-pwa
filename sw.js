/* Bruno Electric Estimating — app shell offline cache. Previous cache: bruno-electric-v53; current: bruno-electric-v54. Historical audited baseline: bruno-electric-v45. */
const CACHE = 'bruno-electric-v54';
...
const CORE_SHELL = [
  ...
  './electric-reference-data.js','./electric-calculators.js','./electric-catalog-v1.js','./electric-bom.js','./electric-electrical-tasks.js','./electric-electrical-task-engine.js','./electrical-tasks-ui.js','./electrical-tasks-stage2-ui.js',
