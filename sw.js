/* Bruno Electric Estimating — app shell offline cache. Previous cache: bruno-electric-v50; accepted baseline cache: bruno-electric-v45; earlier audited cache: bruno-electric-v40. */
const CACHE = 'bruno-electric-v51';
...
const CORE_SHELL = [
  ...
  './electric-dispatch-journal-v2.js','./electric-catalog-cost-semantics.js','./electric-pricing-margins-semantics.js','./electric-job-material-cost-semantics.js','./electric-job-summary-semantics.js','./electric-quote-lifecycle.js','./electric-fixed-price-invoice.js','./electric-catalog-job-ux-semantics.js','./electric-custom-materials.js',
