...
test('service pricing modes and customer PDF download are first-class controls',function(){['serviceHourlyRate:175','pricingMode','Hourly / time based','Fixed job price','PDF invoice','Download calculation PDF','application/pdf'].forEach(function(x){ok(src.indexOf(x)>=0,x+' missing')})});
