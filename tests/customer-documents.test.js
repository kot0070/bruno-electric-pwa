...
test('single runtime build source is wired through deterministic bootstrap',function(){ok(reg.indexOf("BUILD_VERSION='1.15'")>=0,'bootstrap build version is not v1.15');ok(version.indexOf("var VERSION='v1.15'")>=0,'visible app version is not v1.15');ok(reg.indexOf("'./electric-app-version.js'")>=0,'version authority is not bootstrapped')});
