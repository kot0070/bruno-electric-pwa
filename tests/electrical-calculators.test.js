...
test('ambient decimal 30.1C enters 31-35 range',function(){eq(C._test.tempFactor(90,30.1),.96)});
...
test('ampacity invalid material rejected',function(){throws(function(){C.ampacity({material:'copper',size:'6',loadAmps:20})})});
...
test('voltage drop invalid phase',function(){throws(function(){C.voltageDrop({voltage:240,phase:2,material:'Cu',size:'12',distanceFt:50,current:10})})});
test('voltage drop invalid target',function(){throws(function(){C.voltageDrop({voltage:240,phase:1,material:'Cu',size:'12',distanceFt:50,current:10,targetPct:-1})})});
...
test('conduit fill fractional quantity rejected',function(){throws(function(){C.conduitFill({racewayType:'EMT',tradeSize:'3/4',conductors:[{size:'12',qty:2.5}]})})});
...
test('box fill >4 EGC rejected',function(){throws(function(){C.boxFill({size:'12',insulatedCount:4,groundCount:5,yokeCount:1,internalClamp:false,boxVolume:30})})});
...
test('transformer invalid phase rejected',function(){throws(function(){C.transformerCurrent({kva:25,phase:2,primaryVoltage:240,secondaryVoltage:120})})});
