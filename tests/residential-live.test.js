...
test('2000 sqft 20A code branch minimum is 3 even when design grouping raises actual count',function(){var r=E.calculate(base(2000));is(r.summary.generalCircuitCodeMinimum,3);is(r.summary.generalCircuitGroupingCount,4);is(r.summary.generalCircuits,4);is(r.summary.generalBranchCircuitLoadVA,6000)});
