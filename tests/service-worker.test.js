...
asyncTest('service worker activation deletes only owned stale Bruno Electric caches',function(){
  ...
  var cacheNames=['bruno-electric-v23','bruno-electric-v24','bruno-electric-v25','bruno-electric-v26','bruno-electric-v27','bruno-electric-v28','bruno-electric-v29','bruno-electric-v30','bruno-electric-v31','bruno-electric-v32','bruno-electric-v33','bruno-electric-v34','bruno-electric-v35','bruno-electric-v36','bruno-ac-v99','other-pwa-cache','random-cache','bruno-electricity-v24','bruno-electrical-other-v24'];
  ...
  return waited.then(function(){deleted.sort();is(deleted.join('|'),'bruno-electric-v23|bruno-electric-v24|bruno-electric-v25|bruno-electric-v26|bruno-electric-v27|bruno-electric-v28|bruno-electric-v29|bruno-electric-v30|bruno-electric-v31|bruno-electric-v32|bruno-electric-v33|bruno-electric-v34|bruno-electric-v35');var kept=cacheNames.filter(function(x){return deleted.indexOf(x)<0}).sort();is(kept.join('|'),['bruno-ac-v99','bruno-electric-v36','bruno-electrical-other-v24','bruno-electricity-v24','other-pwa-cache','random-cache'].sort().join('|'))});
});
...
asyncTest('service worker core shell includes universal navigation compliance plus accepted modules',function(){
  ...
  if(source.indexOf("bruno-electric-v36")<0)throw new Error('v36 cache missing');
});
