...
asyncTest('service worker core shell includes universal navigation compliance plus accepted modules',function(){
  var source=fs.readFileSync(path.join(__dirname,'..','sw.js'),'utf8');
  ['electric-app-navigation.js','electric-workspace.js','electric-navigation-bridge.js','document-compliance.js','electric-bom.js','electric-residential-rules.js','electric-residential.js','electric-residential-pricing.js','electric-residential-takeoff.js','electrical-residential-ui.js','electrical-residential-pricing-ui.js','electrical-residential-takeoff-ui.js','electric-phase3-rules.js','electric-phase3.js','electrical-phase3-ui.js','electrical-tools-shell.js'].forEach(function(name){if(source.indexOf("'./"+name+"'")<0)throw new Error(name+' missing from core shell')});
