...
asyncTest('service worker activation deletes only owned stale Bruno Electric caches',function(){
  ...
  var cacheNames=['bruno-electric-v23','bruno-electric-v24','bruno-electric-v25','bruno-electric-v26','bruno-electric-v27','bruno-electric-v28','bruno-electric-v29','bruno-ac-v99','other-pwa-cache','random-cache','bruno-electricity-v24','bruno-electrical-other-v24'];
  ...
  return waited.then(function(){deleted.sort();is(deleted.join('|'),'bruno-electric-v23|bruno-electric-v24|bruno-electric-v25|bruno-electric-v26|bruno-electric-v27|bruno-electric-v28');var kept=cacheNames.filter(function(x){return deleted.indexOf(x)<0}).sort();is(kept.join('|'),['bruno-ac-v99','bruno-electric-v29','bruno-electrical-other-v24','bruno-electricity-v24','other-pwa-cache','random-cache'].sort().join('|'))});
});

asyncTest('service worker core shell includes residential takeoff plus accepted modules',function(){
  var source=fs.readFileSync(path.join(__dirname,'..','sw.js'),'utf8');
  ['electric-residential-rules.js','electric-residential.js','electric-residential-pricing.js','electric-residential-takeoff.js','electrical-residential-ui.js','electrical-residential-pricing-ui.js','electrical-residential-takeoff-ui.js','electric-phase3-rules.js','electric-phase3.js','electrical-phase3-ui.js'].forEach(function(name){if(source.indexOf("'./"+name+"'")<0)throw new Error(name+' missing from core shell')});
});
